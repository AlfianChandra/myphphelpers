...
if (is_file('./vendor/ivantcholakov/codeigniter-phpmailer/helpers/MY_email_helper.php')) {
   require_once './vendor/ivantcholakov/codeigniter-phpmailer/helpers/MY_email_helper.php';
}
